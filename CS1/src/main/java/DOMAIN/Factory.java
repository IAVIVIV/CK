...
public class Factory {
	...
	public User createUser(DTO_ID id, String username, String email, String password) {
	...
	public ID createID(DTO_ID idOther) {
	...
	public Message createMessage(DTO_ID id, String sender, String receiver, String content) {
		ID idClone = createID(id);
